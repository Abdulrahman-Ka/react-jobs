      ...
      <div className="container m-auto max-w-2xl py-24">
        <div className="bg-white shadow-md rounded-md p-8 border">
          <form onSubmit={handleSubmit(onSubmit)}>
            <h2 className="text-4xl text-center font-bold mb-6">Add Job</h2>
            <label
              htmlFor="type"
            ...
            <div className="mb-4">
              ...
              <select
                name="salary"
                id="salary"
                {...register("salary", { required: "Please Select a salary" })}
                className="border mb-2 w-full rounded py-1 px-2"
              >
            ...
            <div className="mb-4">
              ...
              {errors.company_description && (
                <FormError errorMessage={errors.company_description.message} />
              )}
            </div>
            ...
            <div className="mb-4">
              ...
              <Controller
                ...
                rules={{
                  ...
                  maxLength: { value: 13, message: "Too long (max 13 digits)" },
                }}
